...
class MemberCreate extends Component
{
    ...
    {
        return view('livewire.member.member-create')->layout('layouts.manta-bootstrap');
    }
    ...
    public function store($input)
    {
        ...
        MantaMember::create($item);

        toastr()->addInfo('Item opgeslagen');

        return redirect()->to(route('manta.member.list'));
    }
}
