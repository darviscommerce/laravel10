        ...
        <ul class="nav nav-tabs mb-4">
            <li class="nav-item">
                <a class="nav-link {{ $pid == null ? 'active' : null }}" aria-current="page"
                    href="{{ route('manta.uploads.update', ['input' => $pid]) }}">{{ config('manta-cms.locales')[config('manta-cms.locale')]['language'] }}
                    ...
                    @foreach ($files as $file)
                        <div class="mantaUploadsDiv ui-sortable-handle" data-id="d4493e00-a81f-11eb-96a3-6f0d8db49bb5">
                            ...
                            <div class="mantaUploadscomments">
                                <a href="javascript:;" {{-- wire:click="main('d4493e00-a81f-11eb-96a3-6f0d8db49bb5')" --}}><i
                                ...
                                <a {{-- href="https://luthermuseum.nl/cms/uploads/cropper/d4493e00-a81f-11eb-96a3-6f0d8db49bb5?redirect=https%3A%2F%2Fluthermuseum.nl%2F%2Fcms%2Fsliders%2Fedit%2F3d431c80-a81f-11eb-b394-4b9eaec0d544" --}}><i class="fa-solid fa-pen-to-square" data-bs-toggle="tooltip"
