<div class="container" wire:init="loadTrash">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Fotoalbums</li>
        </ol>
    </nav>
    <div class="mt-3 row">
        <div class="col-4">
            <a href="{{ route('manta.photoalbum.create') }}" class="btn btn-sm btn-success"><i
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @elseif ($deleteId == null || $deleteId != $item->id)
                            <a href="{{ route('manta.photoalbum.read', ['input' => $item->id]) }}"
