<footer class="footer wf-section">
    <div class="container_1240px">
            ...
            <div class="footer-column-1"><img src="/theme/ccs/images/logo_wit.png" alt="Logo Compri Aluminium"
                ...
                <div class="footer-in-column w-row">
                    <div class="w-col w-col-6">
                        <div><strong>Adres</strong><br>Everdongenlaan 5<br>2300 Turnhout<br>België</div>
                        <div class="social-media">
                            <a href="https://www.linkedin.com/company/14024355/" target="_blank"
        ...
        s-41.689-109.131-99.934-109.131s-82.768,45.369-82.768,45.369V187.333z">
                            ...
                            <a href="https://www.facebook.com/compricoatingservice" target="_blank"
                            ...
                            <a href="#" class="icon_social-media twitter w-inline-block">
                                <div class="icon-footer w-embed"><svg width="100%" height="100%" viewbox="0 0 20 16"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <a href="#" class="icon_social-media instagram w-inline-block">
                                <div class="icon-footer w-embed"><svg width="100%" height="100%" viewbox="0 0 15 15"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="footer-in-column_right w-col w-col-6">
                        <div><strong>Openingstijden</strong><br>Maandag t/m donderdag:  08.00 – 16.30<br>Vrijdag :
                            08.00 – 15.30<br>Zaterdag &amp; zondag: gesloten</div>
                    </div>
                </div>
            </div>
            <div class="footer-column-2">
                ...
                <a href="over.html" class="footer-link w-inline-block">
                    <div>Over Compri Coating</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
                <a href="waarom.html" class="footer-link w-inline-block">
                    <div>Waarom Compri Coating</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
                <a href="service.html" class="footer-link w-inline-block">
                    <div>Service</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
                <a href="coatingsystemen-kleuren.html" class="footer-link w-inline-block">
                    <div>Coatingsystemen &amp; kleuren</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
            </div>
            <div class="footer-column-3">
                <div class="footer-header hide-mobile-portrait"></div>
                <a href="capaciteit.html" class="footer-link w-inline-block">
                    <div>Capaciteit</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
                <a href="certificering-qualicoat.html" class="footer-link w-inline-block">
                    <div>Certificering Qualicoat</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
                <a href="vacatures.html" class="footer-link w-inline-block">
                    <div>Vacatures</div>
                    <div class="fontawesome margin-left_xs"></div>
                </a>
    ...
    <div class="footer-bottom">
        <div>© 2022 Compri Group. Op al onze leveringen zijn onze algemene voorwaarden van toepassing.</div>
        <div class="footer-bottom_links-wrapper">
            <a href="#" target="_blank" class="footer-bottom_link">Algemene voorwaarden</a>
            <a href="#" target="_blank" class="footer-bottom_link">Privacy Policy</a>
            <a href="#" target="_blank" class="footer-bottom_link">Disclaimer</a>
        </div>
    </div>
</footer>
