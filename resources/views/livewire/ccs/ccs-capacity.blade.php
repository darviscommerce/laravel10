...
@section('title', 'Capaciteit')
@section('description', 'Capaciteit')
<main>
        ...
        <main data-w-id="0328a841-086c-0cfc-2db9-a3fe0d938e2e"
            ...
            <article class="w-clearfix">
                ...
                <article class="article w-richtext">
                    <h4>Zowel stukwerk als grote reeksen</h4>
                    <p><br>Onze installaties hebben een totaal capaciteit van ca. 300.000 m² per jaar. Zowel stukwerk
                        als grote reeksen kunnen wij voor u behandelen, gaande van plaatwerk, profielen op
                        handelslengten of verzaagd op fix-lengten, bewerkte of gelaste samengestelde stukken en/of
                        kleine onderdeeltjes.<br><br>Wij beschikken over een badenreeks voor de chemische
                        voorbehandeling met daarop aansluitend2 poederlakinstallaties</p>
                    <ul role="list">
